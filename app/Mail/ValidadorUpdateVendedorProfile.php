...
class ValidadorUpdateVendedorProfile extends Mailable
{
    ...
    public function build()
    {
        ...
        $cuerpo = $this->vendedor->name.' '.$this->vendedor->lastname.' ha solicitado una revisión de su información. Para ponerse en contacto con él te proporcionamos su información de contacto y posteriormente podrás hacer los cambios pertinentes haciendo click en el botón.<br>br>Correo: '.$this->vendedor->email.'<br> Teléfono: '.$this->vendedor->phone;

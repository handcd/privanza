                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if( $orden->precio && $orden->consecutivo_op || $orden->precio && !$orden->consecutivo_op || !$orden->precio && $orden->consecutivo_op)
                                ...
                                <td>
                                    <div class="col-sm-12" style="float: right;">
                                        <a href="{{ url('/admin/ordenes/'.$orden->id.'/editarPrecioOP') }}" class="btn btn-success btn-large"><i class="material-icons">add</i>Editar Precio/C-OP</a>
                                    </div>
                                </td>
                            @elseif( !$orden->precio && !$orden->consecutivo_op )
                                ...
                                <td colspan="2">
                                    <div class="col-sm-12" style="float: right;">
                                        <a href="{{ url('/admin/ordenes/'.$orden->id.'/editarPrecioOP') }}" class="btn btn-success btn-large"><i class="material-icons">add</i>Agregar Precio y consecutivo de operación</a>
                                    </div>
                                </td>
                                <td></td>
                            @endif

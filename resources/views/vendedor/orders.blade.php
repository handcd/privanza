                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="td-actions text-right">
                                <a href="#" type="button" rel="tooltip" title="Ver Orden" class="btn btn-success btn-simple btn-xs">
                                    <i class="material-icons">remove_red_eye</i>
                                </a>
                                 <a href="#" type="button" rel="tooltip" title="Editar" class="btn btn-primary btn-simple btn-xs">

                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="{{ url('/validador/clientes/'.$cliente->id) }}" type="button" rel="tooltip" title="Ver Cliente" class="btn btn-primary btn-simple btn-xs">
                    ...
                    <div class="tab-pane active" id="todayEvents">
                        <table class="table table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $evento->id }}</td>
                                    <td><a href="{{ url('/validador/clientes/'.$evento->client->id) }}">{{ $evento->client->name.' '.$evento->client->lastname }}</a></td>

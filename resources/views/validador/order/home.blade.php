                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if( $orden->precio && $orden->consecutivo_op || $orden->precio && !$orden->consecutivo_op || !$orden->precio && $orden->consecutivo_op)
                                ...
                                <td>
                                    <div class="col-sm-12" style="float: right;">
                                        <a href="{{ url('/validador/ordenes/'.$orden->id.'/editar') }}" class="btn btn-success btn-large"><i class="material-icons">add</i>Editar Precio/C-OP</a>
                                    </div>
                                </td>
                            ...
                            @elseif( !$orden->precio && !$orden->consecutivo_op )
                                <td colspan="2">
                                    <div class="col-sm-12" style="float: right;">
                                        <a href="{{ url('/validador/ordenes/'.$orden->id.'/editar') }}" class="btn btn-success btn-large"><i class="material-icons">add</i>Agregar Precio/C-OP</a>
                                    </div>
                                </td>
                                <td></td>
                            @endif

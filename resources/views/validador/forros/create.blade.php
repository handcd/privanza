    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <form action="{{ url('/validador/forros/') }}/@yield('editId')" method="post" onsubmit="return confirm('¿La información que deseas registrar es correcta?');">
                    {{ csrf_field() }}
                    @section('editMethod')
                        @show
                    ...
                    <a href="{{ url('/validador/forros') }}" class="btn btn-default">Cancelar</a>

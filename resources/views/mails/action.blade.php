					...
					<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
						...
						<tr>
							...
							<td width="500" align="center">
								<div class="contentEditableContainer contentTextEditable" >
			                        <div class="contentEditable" >
			                            <p >Fecha del Mensaje: {{ Carbon\Carbon::now()->toDateTimeString() }}</p>
			                        </div>
			                    </div>
							</td>
							<td width="50">&nbsp;</td>
				...
				<div class='movableContent'>				
					<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
						...
						<tr>
							...
							<div class="contentEditableContainer contentTextEditable">
								<div class="contentEditable" >
									<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Enviado automáticamente por Privanza</span>
									<br/>
									<span style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Calz. de Tlalpan 1134, Zacahuitzco, 03550 Ciudad de México, CDMX</span>
									<br/>
									<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">
									<a target='_blank' href="mailto:soporte@privanza.handcreativedesign.com.mx" style="text-decoration:none;color:#555">Quejas y sugerencias click aquí</a></span>
								</div>
							</div>

...
var ajusteContainer = document.getElementById('ajustes-container');
var noAjustes = 0;

function addAdjustment() {
	var fechaCliente = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
	var fechaPlanta = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
	var noPrendas = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
	var tipoPrenda = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
	var descripcion = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '';
	...
	var inputs = '<div class="form-group label-floating">' + '<label class="control-label">Número de Prendas</label>' + '<input type="number" min="1" step="1" name="num_prendas[]" id="num_prendas' + noAjustes + '" class="form-control" value="' + noPrendas + '">' + '</div>' + '<div class="form-group label-floating">' + '<label class="control-label">Tipo de Prenda</label>' + '<input type="text" name="tipo_prenda[]" id="tipo_prenda' + noAjustes + '" class="form-control" value="' + tipoPrenda + '">' + '</div>';

	$(col3).append(inputs);
	row.appendChild(col3);

	// Create 4th column
	var input = '<div class="col-md-3">' + '<div class="form-group label-floating">' + '<label class="control-label">Descripción del Ajuste</label>' + '<textarea name="descripcion[]" id="descripcion' + noAjustes + '" cols="30" rows="10" class="form-control">' + descripcion + '</textarea>' + '</div>' + '<button type="button" id="eliminarAjuste' + noAjustes + '" class="btn btn-danger pull-right">Eliminar Ajuste #' + (noAjustes + 1) + '</button>' + '</div>';
...
var botonAjuste = document.getElementById('botonajuste');
...
var consecutivoOp = document.getElementById('consecutivo_op2');
